...
```{r local-test-parallelGC, echo=FALSE, warning=FALSE}
plot_througput_vs_checkpoints("../../logs/client/benchmark.log", "../../logs/server/app.log")
```
...
```{r local-test-ZGC, echo=FALSE, warning=FALSE}
plot_througput_vs_checkpoints("../../logs/client/benchmark.log", "../../logs/server/app.log")
```